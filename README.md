...
- Custom BVH with [SweepSAH](https://github.com/BoyBaykiller/IDKEngine#good-bvhs-with-sweepsah) and [PreSplitting](https://github.com/BoyBaykiller/IDKEngine#better-bvhs-with-presplitting)
- Textures and output images with [image](https://crates.io/crates/image)
